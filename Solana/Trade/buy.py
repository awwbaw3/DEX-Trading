...
# Now you can safely use `config` because it has been defined
async_solana_client = AsyncClient(config["RPC_HTTPS_URL"])
solana_client = Client(config["RPC_HTTPS_URL"])
print("RPC_HTTPS_URL:", config["RPC_HTTPS_URL"])
...
async def main():
    ...
    token_toBuy="EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v" #Enter token you wish to buy here
