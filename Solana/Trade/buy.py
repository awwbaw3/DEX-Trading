...
async def main():
    secret_key_bytes = base58.b58decode(os.getenv('PRIVATE_KEY'))
    payer = Keypair.from_bytes(secret_key_bytes)
    
    print(payer.pubkey())
    token_toBuy = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"  # Enter the token you wish to buy here
    buy_transaction = await buy(solana_client, token_toBuy, payer, 0.01)  # Enter the amount of SOL you wish to spend
